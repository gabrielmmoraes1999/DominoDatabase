 ...
 */
public class InternaPGConfig extends javax.swing.JInternalFrame {

    InternaConversao ic;
    
    public InternaPGConfig(InternaConversao ic) {
        this.ic = ic;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Configuração PostgreSQL"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pg.connect(jTextField1.getText(), jTextField2.getText(), jTextField3.getText());
            InternaConversao.databasePG = jTextField1.getText();
            InternaConversao.usernamePG = jTextField2.getText();
            InternaConversao.passwordPG = jTextField3.getText();
